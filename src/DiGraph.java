...
//Here are the lines of code that I tried to fix, but am unsure of.
//170, 224, 229, 330, 426
//236 is confusing
...
//            }
            ...
            // Copy the integer indices
            for (Integer key : thatGraph.transposeEdgeMap)
            {
                transposeEdgeMap.Add(pair.Key, new ArrayList<Integer>(pair.Value));
            }
